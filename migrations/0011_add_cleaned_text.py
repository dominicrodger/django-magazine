...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.cleaned_text'
        db.add_column('magazine_article', 'cleaned_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.cleaned_text'
        db.delete_column('magazine_article', 'cleaned_text')
