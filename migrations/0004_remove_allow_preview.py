...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.allow_preview'
        db.delete_column('magazine_article', 'allow_preview')


    def backwards(self, orm):
        
        # Adding field 'Article.allow_preview'
        db.add_column('magazine_article', 'allow_preview', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
