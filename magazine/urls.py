...
from magazine.views import (CurrentIssueListView, IssueListView, IssueView,
                            ArticleView, AuthorListView, AuthorListViewAlphabetised,
                            AuthorDetailView, BookReviewView, AuthorArticlesView,
...
urlpatterns = patterns('',
    ...
    url(r'^authors/alphabetised/$', AuthorListViewAlphabetised.as_view(), name='magazine_authors_alphabetised'),
