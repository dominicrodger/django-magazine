...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Author.details'
        db.delete_column('magazine_author', 'details')


    def backwards(self, orm):
        
        # Adding field 'Author.details'
        db.add_column('magazine_author', 'details', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)
