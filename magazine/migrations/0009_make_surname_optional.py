...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('magazine_author', 'surname', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Author.surname'
        db.alter_column('magazine_author', 'surname', self.gf('django.db.models.fields.CharField')(max_length=100))
